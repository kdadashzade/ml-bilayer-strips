...
GEOMETRY_LABEL = 'Geometry 1'
csv_path       = 'data/report/Geom1_Data.csv' 
output_csv     = 'data/report/Geom1_PolyResults.csv'

target_column   = 'Deflection_mm'
feature_columns = ['Length_mm', 'Total_Thick_mm', 'Shrinkage_Strain']
